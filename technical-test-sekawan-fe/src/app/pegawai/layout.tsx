...
import NavbarPegawai from "./NavbarComponent";
...
function PegawaiLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex">
      <NavbarPegawai openSideBar={isSidebarOpen} closeSidebar={closeSidebar} />
...
export default withAuth(PegawaiLayout, ["Pegawai"]);
